...
Calendar.prototype = {
    ...
    for (var t = document.createElement("UL"), n = 0; n < e.length; n++) {
        ...
        null == e[n].link || "" == e[n].link ? o.appendChild(l) : ((d = document.createElement("A")).href = e[n].link, d.target = "_blank", d.class = this.id + " link", d.appendChild(l), o.appendChild(d)), i.appendChild(a), i.appendChild(o), t.appendChild(i)
    }
    return t.innerHTML
    ...
    document.getElementById(a.id + "-day-" + t).onclick = function() {
        ...
        var currentDate = (calendar.date.getMonth() + 1) + "/" + calendar.date.getDate() + "/" + calendar.date.getFullYear();
...
function TodayBtnClicked(e) {
    var t = new Date();
    calendar.date.setDate(t.getDate());
    calendar.date.setMonth(t.getMonth());
    calendar.date.setFullYear(t.getFullYear());
    calendar.update(t);
}
